...
const Descover = () => {
    return (
        <div className='xl:w-[1320px] pt-20 mx-auto flex flex-col lg:flex-row gap-4 justify-between font-montserrat'>
            <div className='bg-[#002944] lg:w-1/2 flex flex-col lg:flex-row md:flex-row justify-between gap-10 items-center p-4 rounded-xl mx-3'>
                <div className='space-y-4 xl:pl-7'>
                    <h1 className='text-xl'>Don't miss opportunity!</h1>
                    <h1 className='text-3xl italic'>Discover Offer 2024 Collection</h1>
                    <p className='flex items-center gap-2'><span className='border-b'>Shop now</span> <BsArrowRight size={20} />
 </p>
                </div>
