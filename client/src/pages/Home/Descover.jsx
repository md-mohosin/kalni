...
const Descover = () => {
    return (
        <div className='xl:w-[1320px] mx-auto flex flex-col lg:flex-row gap-4 pb-[120px]'>
            <div className='bg-[#002944] flex justify-between gap-10 items-center p-4 rounded-xl'>
            ...
            <div className='bg-[#68A7F1] flex justify-between gap-10 items-center p-4 rounded-xl'>
                <div className='space-y-4'>
                    <h1 className='text-xl'>Don't miss opportunity!</h1>
                    <h1 className='text-2xl'>Discover Offer 2024 Collection</h1>
                    <p>Shop now</p>
